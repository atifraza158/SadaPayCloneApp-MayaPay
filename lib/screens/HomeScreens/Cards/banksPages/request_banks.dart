...
class RequestBanksScreen extends StatefulWidget {
  const RequestBanksScreen({super.key});

  @override
  State<RequestBanksScreen> createState() => _RequestBanksScreenState();
}

class _RequestBanksScreenState extends State<RequestBanksScreen> {
  @override
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          "No recent money requests",
                          style: acountNameHeading,
                        ),
                        SizedBox(height: 10),
                        Text(
                          "Request money to show here",
                          style: details4Text,
                        ),
                      ],
                    )
